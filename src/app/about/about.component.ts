...
export class AboutComponent implements OnInit {
  ...
  algoSummary: string =
    "Due to having studied Maths & Physics instead of Computer Science I hadn't had much exposure to algorithms. I created this algorithm visualiser as a way to learn a bit more about them. I currently have a visualisation for 3 different ones but there may be more to come in the future.";
  tetrisSummary: string =
    "I started this Tetris game a little while ago as a way to teach myself some JavaScript when I was still relatively new to coding. This was initially incomplete and very buggy. When I was building this site I decided to go back to it and it is now a fully functional tetris game with a couple of additional mechanics.";
  constructor() {}
